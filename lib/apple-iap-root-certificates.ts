...
/**
 * Public Apple trust anchors downloaded from Apple's PKI root-certificate
 * section. These are certificates, not credentials. Keep the complete PEM
 * blocks and verify their fingerprints whenever Apple rotates its published
 * roots: https://www.apple.com/certificateauthority/
 */
...
export const APPLE_IAP_ROOT_CERTIFICATES = [
  Buffer.from(APPLE_ROOT_CA),
  Buffer.from(APPLE_ROOT_CA_G2),
