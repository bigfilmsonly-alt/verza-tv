...
8. **Paid playback is server-authorized and signed mode is live.** The complete map has 4,262 rows:
   4,212 live rows, 459 intentionally public/free rows, 3,753 paid-live rows
   with signed counterparts, and 50 coming-soon rows. Runtime clients receive
   only the 459-row public capability projection; 3,803 capabilities are
   withheld. Production readback shows unentitled paid access 402 with no
