...
| `CategoryTabs.tsx` | Category tab bar (Drama, Hot, Tubi, Anime, Español, Bollywood, Creators, Reality, Red Carpet, Music). Tubi renders its partner logo (`public/tubi-logo.png`); Tubi/Anime/Español/Bollywood/Creators are Coming Soon. Sticky `top:48`. |
