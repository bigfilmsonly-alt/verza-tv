...
/* ------------------------------------------------------------------ */
/*  Shared button styles (match existing sign-in / sign-up pages)      */
/* ------------------------------------------------------------------ */
const btnClass =
  "w-full rounded-xl px-4 py-3 text-sm font-semibold flex items-center justify-center gap-3 transition-opacity hover:opacity-90";
const btnStyle = {
