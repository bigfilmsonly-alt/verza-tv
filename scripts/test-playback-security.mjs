...
if (publicMapAudit.status !== 0) {
  ...
  !publicMapAudit.stdout.includes("intentionally public IDs: 539") ||
  !publicMapAudit.stdout.includes("protected IDs withheld: 4616")
) {
